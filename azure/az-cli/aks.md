...
#### [Start an AKS cluster](https://learn.microsoft.com/en-us/azure/aks/start-stop-cluster?tabs=azure-cli) (The cluster restarts with the previous control plane state and number of agent nodes)
```
